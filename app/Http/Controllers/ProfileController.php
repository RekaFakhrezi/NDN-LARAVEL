...
class ProfileController extends Controller
{
    ...
    {
        // Mengambil data user beserta artikel-artikelnya yang berstatus 'approved/published'
        $user = \App\Models\User::findOrFail($id);
        $articles = \App\Models\Article::where('user_id', $id)
            ->where('status', 'approved') // Sesuaikan dengan status artikel tayang di database kamu
            ->latest()
            ->get();
