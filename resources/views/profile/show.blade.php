    ...
    <div class="min-h-screen bg-[#fafafa] pb-20 font-sans">
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 -mt-16 md:-mt-24 relative z-10">
                ...
                <div class="flex flex-col md:flex-row gap-6 items-center md:items-start">
                    ...
                    <div class="pt-2">
                        ...
                        <p class="text-sm text-gray-700 leading-relaxed max-w-lg">
                            Berkomitmen menyajikan berita faktual dan mendalam. Fokus pada isu-isu sosial, teknologi,
                            dan perkembangan terkini di Nusantara.
                        </p>
                    </div>
                </div>
            ...
            <div class="mb-6 border-b border-gray-200 pb-2">
                <h2 class="text-xl font-serif font-bold text-gray-900 border-l-4 border-[#bd2828] pl-3">Karya Tulis
                    ({{ $articles->count() ?? 0 }})</h2>
            </div>
